...
"""
        self.assertEqual(determine_execution_route(_req(helper), memory), FAST_PATH)
    ...
    def test_title_generation_no_agent_test(self):
        ...
        self.assertEqual(determine_execution_route(_req(prompt), memory), FAST_PATH)
...
"""
    ...
    def test_approval_yes_not_hijacked_by_helper_test(self):
        ...
        self.assertEqual(determine_execution_route(_req("yes"), memory), AGENT_PATH)
